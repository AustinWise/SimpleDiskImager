...
namespace Austin.ThumbWriter.DiskImages
{
    static class VhdDiskImage
    {
        ...
        public static DiskImage Create(DiskImage hdd)
        {
        ...
        class FixedVhd : OffsetDiskImage
        {
        ...
        class DynamicVhd : OffsetTableDiskImage
        {
            const int SECTOR_SIZE = 512;

            long mSize;

            public DynamicVhd(DiskImage hdd, in VhdHeader head)
                : base(hdd)
            {
